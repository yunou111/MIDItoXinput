...
【追記】応答速度が速くなるよう修正しました。（一般的なパッドよりまだ20ms遅い）（2025/8）<br>
　　　　コントローラー遅延計測.htmlを追加しました。（HTMLとして保存して開いてください）(2025/9)<br>
USBホストシールドのICチップの種類を確認してください。種類によってはんだする箇所が5Vか3.3Vか変わります。（ https://note.com/ken_rxj/n/ne51e6d853203 ）(2026/3)<br>
<br>
### 必要なハードウェア  
